...
if (isset($_GET["entries"])) {
    $limitDataPerHalaman = $_GET["entries"];
} else {
    ...
    <div class="card my-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex">
                    <!-- Form untuk menampilkan jumlah entri -->
                    <form action="" method="get" class="mb-3 d-flex align-items-center">
                        <label for="showEntries" style="width: 120px;"  class="me-2">Show Entries:</label>
                        <select name="entries" id="showEntries" class="form-select w-50" onchange="this.form.submit()">
                    ...
                    <a href="form_order.php" class="btn btn-primary mb-3 ms-3">
                        Tambah Order
                    </a>
                </div>
