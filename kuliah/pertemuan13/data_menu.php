                    ...
                    <?php if (!empty($listMenu)) : ?>
                        <?php foreach ($listMenu as $menu) : ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalUbah<?= $menu["id_menu"] ?>">Ubah</button>
                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $menu["id_menu"] ?>">Hapus</button>
                                </td>
                            </tr>
                            <!-- modal ubah -->
